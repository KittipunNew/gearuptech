...
const FilterProduct = ({ setFilterProduct }) => {
  ...
  return (
    <>
      {/* Mobile & Tablet */}
      <div className="bg-white flex justify-center items-center p-5 rounded-lg lg:hidden md:mt-5">
      ...
      {/* Desktop */}
      <div className="hidden lg:flex flex-col justify-center items-center  h-full bg-white rounded-lg shadow-lg mt-10 p-5 md:mt-20 lg:mt-0 lg:w-60 lg:justify-start lg:items-start">
